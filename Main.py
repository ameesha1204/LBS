...
frappe_client = FrappeClient("https://your-frappe-instance.com", "your-api-key", "your-api-secret")
...
def get_frappe_data():
    try:
        # Make a request to the Frappe API to get data
        data = frappe_client.get_api("your-endpoint", params={"param_key": "param_value"})
        # Process and display the data
        messagebox.showinfo("Frappe Data", str(data))
